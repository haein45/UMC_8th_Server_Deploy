...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    public final umc.spring.domain.entity.QFoodCategory foodCategory;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new umc.spring.domain.entity.QFoodCategory(forProperty("foodCategory")) : null;
        this.member = inits.isInitialized("member") ? new umc.spring.domain.entity.QMember(forProperty("member")) : null;
    }
